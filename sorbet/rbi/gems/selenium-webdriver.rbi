...
class Selenium::WebDriver::Chrome::Driver < Selenium::WebDriver::Chromium::Driver
  ...
  def initialize(options: nil, service: nil, url: nil, **opts); end
...
class Selenium::WebDriver::Chromium::Options < Selenium::WebDriver::Options
  ...
  def enable_android(package: nil, serial_number: nil, use_running_app: nil, activity: nil); end
  def encode_extension(path); end
  def extensions; end
  def extensions=(extensions); end
  def initialize(profile: nil, **opts); end
  def logging_prefs; end
  def logging_prefs=(arg0); end
...
class Selenium::WebDriver::Remote::Bridge
  ...
  def action(async: nil, devices: nil, duration: nil); end
  def actions(async: nil, devices: nil, duration: nil); end
  def active_element; end
  ...
  def find_element_by(how, what, parent_ref = nil); end
  def find_elements_by(how, what, parent_ref = nil); end
  ...
  def http; end
  def http=(arg0); end
  def initialize(url:, http_client: nil); end
  ...
  def print_page(options = nil); end
  def quit; end
  def refresh; end
  def release_actions; end
  ...
  def self.add_command(name, verb, url, &block); end
  def self.element_class; end
  def self.element_class=(arg0); end
  def self.extra_commands; end
  def self.locator_converter; end
  def self.locator_converter=(arg0); end
...
class Selenium::WebDriver::Remote::Http::Common
  ...
  def self.extra_headers=(arg0); end
  def self.user_agent; end
  def self.user_agent=(arg0); end
  def server_url; end
...
class Selenium::WebDriver::Remote::Capabilities
  ...
  def self.json_create(data); end
  def self.process_timeouts(caps, timeouts); end
  def set_window_rect; end
  def set_window_rect=(value); end
  def strict_file_interactability; end
  def strict_file_interactability=(value); end
...
class Object < BasicObject
  def fetch_all_items_with(arg0, arg1, arg2, &blk); end
  def main; end
